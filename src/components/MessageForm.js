        ...
        <>
                ...
                {user && privateMemberMsg?._id && (
                    <>
                        <div className="alert alert-info conversation-info">
                            <div>
                                <img src={privateMemberMsg.picture} className="conversation-profile-pic" alt=""/>  {privateMemberMsg.name}
                            </div>
                        </div>
                    </>
                )}
            ...
            <Form onSubmit={handleSubmit}>
                <Row>
                    ...
                    <Col md={1}>
                        <Button className="msg-btn" type="submit" style={{ width: "100%", backgroundColor: "#54da9e" }} disabled={!user}>
